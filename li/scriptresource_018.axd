...
}},_onLocalMouseMoveHandler:function(j){if(!Telerik.Web.UI.Grid){return;
}this._canDragDrop=true;
this._canResize=false;
var k=Telerik.Web.UI.Grid.GetCurrentElement(j);
var f=Telerik.Web.UI.Grid.GetFirstParentByTagName(k,"th");
var a=Telerik.Web.UI.Grid.FindPosX(k);
...
}if(this._owner._owner.ClientSettings.Resizing.AllowColumnResize&&this.get_resizable()&&Telerik.Web.UI.Grid.GetEventPosX(j)>=(a+f.offsetWidth-5)&&!Telerik.Web.UI.Grid._moveHeaderDiv){this._canDragDrop=false;
}if(this._owner._owner.ClientSettings&&this._owner._owner.ClientSettings.Resizing.AllowColumnResize&&this.get_resizable()&&this.get_element().tagName.toLowerCase()=="th"){var b=Telerik.Web.UI.Grid.GetEventPosX(j);
var g=Telerik.Web.UI.Grid.FindPosX(this.get_element());
var i=g+this.get_element().offsetWidth;
var k=Telerik.Web.UI.Grid.GetCurrentElement(j);
...
}if((b>=i-this._resizeTolerance)&&(b<=i+this._resizeTolerance)&&!this._owner._owner.MoveHeaderDiv){this.get_element().style.cursor="e-resize";
this.get_element().title=this._owner._owner.ClientSettings.ClientMessages.DragToResize;
this._canResize=true;
k.style.cursor="e-resize";
this._owner._owner._isResize=true;
}else{if(this.get_element().style.cursor!="move"){this.get_element().style.cursor="";
k.style.cursor="";
this.get_element().title="";
}if(k.style.cursor=="e-resize"){k.style.cursor="";
}this._canResize=false;
...
var n=e.getFilterControlID(e.FilterControl.RadComboBox,e.IdSuffix.SecondCond);
var m=h.findItemByValue("FilterMenuContainer").findControl(n).get_selectedItem().get_value();
var c;
var f;
var j=true;
...
j=false;
}else{var i=function(p){return function(q){return(p==e.FilterControl.RadDateInput)?q._dateFormat:q._dateInput._dateFormat;
};
}(e.FilterControlsType);
var o=e.FirstFilterValueControl.get_selectedDate();
if(!!o){c=o.localeFormat(i(e.FirstFilterValueControl));
}var a=e.SecondFilterValueControl.get_selectedDate();
if(!!a){f=a.localeFormat(i(e.SecondFilterValueControl));
}}}if(j){if(!(!!c)){c="";
}if(!(!!f)){f="";
}}var k=g._data.UniqueName+"|?"+d+"|"+c+"|?"+m+"|"+f;
